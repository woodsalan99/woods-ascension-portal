      ...
      <div className="wa-geo-wrap">
        <div className="wa-geo-frame">
          <div
            ...
            role="img"
            aria-label={`Map of your ranking for "${scan.keyword}" across ${rows * cols} spots on the island`}
          >
            {cells.map((n, i) => (
        ...
        <div>
          <div className="wa-geo-stat">
            ...
            <div className="wa-geo-stat-delta">across all {cells.length} spots we checked</div>
          </div>
          <div className="wa-geo-stat">
