...
// The original (COLD_EMAIL) Overview body, extracted verbatim out of
// (dashboard)/page.tsx so the page can fork on Client.type — see
// IMPLEMENTATION_STATE.md D-A. Nothing in here changed.
export async function ColdEmailOverview() {
